...
import com.ustgloal.springboot.service.EmployeeService;
...
public class EmployeeController {
	...
	@GetMapping(path="/exce",produces=MediaType.APPLICATION_JSON_VALUE,consumes=MediaType.APPLICATION_JSON_VALUE)
